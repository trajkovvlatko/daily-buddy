    ...
    <>
      <div className="rw-segment">
        <header className="rw-segment-header">
          <h2 className="rw-heading rw-heading-secondary">ItemType {itemType.id} Detail</h2>
        </header>
      ...
      <nav className="rw-button-group">
        <Link to={routes.editItemType({ id: itemType.id })} className="rw-button rw-button-blue">
          Edit
        </Link>
        <button type="button" className="rw-button rw-button-red" onClick={() => onDeleteClick(itemType.id)}>
          Delete
        </button>
      </nav>
    </>
